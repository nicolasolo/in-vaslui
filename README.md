...
vaslui-online has a PRO version with a huge number of components, sections and examples: **[vaslui-online PRO](https://creative-tim.com/live/paper-kit-2-pro)** . Based on feedback from people that downloaded and used it, we have added needed components and we have created multiple examples pages. We are curious to see how you want to use it and also improve it, so let us know any feedback you have.
...
## Documentation
The documentation for the vaslui-online is hosted at our [website](https://demos.creative-tim.com/paper-kit-2/docs/1.0/getting-started/introduction.html).
...
- Paper Kit Bootstrap 3: <index.html>
...
We use GitHub Issues as the official bug tracker for the vaslui-online. Here are some advices for our users that want to report an issue:

1. Make sure that you are using the latest version of the vaslui-online. Check the CHANGELOG from your dashboard on our [website](https://www.creative-tim.com/?ref=pk2-github-readme).
